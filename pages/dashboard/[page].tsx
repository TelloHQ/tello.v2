...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>{page} | Dashboard | Tello</title>
        ...
        >
          ...
          >
            <div className={`pb-3 mb-1 border-b-[#E3E3E3] border-b-[1px]`}>
              <div
                className={`rounded-[4px] overflow-hidden flex-nowrap transition-all delay-500 hover:border-l-[#f89e8e] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] border-solid ${page === "home" || page === undefined ? active : ""} flex items-center transition-all delay-500 bg-[#F5F8FE] py-[9px]`}
              >
                <Link
                  href="/dashboard"
            ...
            <div
              className={`rounded-[4px] overflow-hidden flex-nowrap my-1 ${(page === "userpages" || page === "pages" || page === "page")
                ? active
                : ""
                } border-solid hover:border-l-[3px] border-l-transparent text-[#A9A9A9] hover:border-l-[#3DB5E6] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] flex cursor-pointer items-center py-[9px]`}
            >
              <Link
            ...
            <div
              className={`rounded-[4px] cursor-pointer overflow-hidden flex-nowrap my-1 border-solid hover:border-l-[3px] hover:border-l-[#3DB5E6] border-l-transparent text-[#A9A9A9] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] flex items-center py-[9px] ${(page === "links" || page === "link") ? active : ""
                }`}
            >
              <Link
            ...
            <div
              className={`rounded-[4px] cursor-pointer overflow-hidden flex-nowrap my-1 border-solid hover:border-l-[3px] hover:border-l-[#3DB5E6] hover:text-[#3DB5E6] border-l-transparent text-[#A9A9A9] hover:bg-[#F5F8FE] flex items-center py-[9px] ${(page === "settings" || page === "setting") ? active : ""
                }`}
            >
              <Link
            ...
            <div className="rounded-[4px] cursor-pointer overflow-hidden flex-nowrap my-1 border-solid flex items-center hover:border-l-[3px] hover:border-l-[#3DB5E6] border-l-transparent text-[#A9A9A9] hover:text-[#3DB5E6] hover:bg-[#F5F8FE] py-[9px]">
              <div
                className="text-inherit flex items-center text-[14px]"
                onClick={async () => {
                  if (isAuthenticated) {
